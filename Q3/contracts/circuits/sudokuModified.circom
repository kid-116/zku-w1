...
template sudoku() {
    ...
    component rangePuz[9][9];
    component rangeSol[9][9];
    ...
    for (var i=0; i<9; i++) {
        for (var j=0; j<9; j++) {
            ...
            rangePuz[i][j] = RangeProof(32);
            rangePuz[i][j].in <== puzzle[i][j];
            rangePuz[i][j].range[0] <== 0;
            rangePuz[i][j].range[1] <== 9;
            rangePuz[i][j].out === 1;
            ...
            rangeSol[i][j] = RangeProof(32);
            rangeSol[i][j].in <== solution[i][j];
            rangeSol[i][j].range[0] <== 0;
            rangeSol[i][j].range[1] <== 9;
            rangeSol[i][j].out === 1;
